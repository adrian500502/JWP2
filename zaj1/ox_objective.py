class TicTacToe:
    def __init__(self):
        ...
        self.currentPlayer, self.nextPlayer = self.X, self.O  # X wykonuje ruch jako pierwszy, O jako następny.
    ...
    def isValidSpace(self, space):
        ...
        if space is None or space not in self.ALL_SPACES:
            return False
        return self.board[space] == self.BLANK
